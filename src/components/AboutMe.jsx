          ...
          <div className="relative lg:left-20 left-0 flex flex-col lg:flex-row items-center justify-center">
            <div className="lg:w-3/5 bg-white p-6 rounded-lg drop-shadow-lg mt-4 peer hover:z-30 z-10 transform transition-all duration-300 hover:-translate-y-2 ">
              ...
              <p className="text-gray-700 text-sm sm:text-base">
                What's up? I am an 19 year old computer science student studying
                at Northeastern University based in Boston MA. I like cartoons,
                card games, and working out. Devious at magic the gathering.
                Catch me stomping your local FNM (Friday Night Magic). That's me
                on the right working at a boba shop. I think I look pretty fly
                in an apron. I have been loving the work I have been doing with
                software! That's about it. Check out my projects below!
              </p>
            </div>
